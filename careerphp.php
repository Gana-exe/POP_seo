<?php
	...
	if(isset($_POST['tech_submit1'])) 
	{
        
    
        $email_from = $_POST['tech_email1']; // required
        
        
		$tech_file=$_POST['tech_file1'];
		
		$upload_file=$_FILES['tech_file1']['name'];
	 	$files=$_FILES['tech_file1']['tmp_name'];
            ...
            <div style="background:#fff; padding:44px 34px; width:526px; float:left;">
                    ...
                    <tr style="margin-bottom:5px; width:100%; float:left; border-bottom:#fff 1px solid;">
                      <td style=" padding:5px; width:120px;float:left;"><b>Email</b></td>
                        <td style="  float:left; padding:5px;text-decoration:none;color:#000;">&nbsp; '.$_POST['tech_email1'].'</td>
                    </tr>
...
$email = $id;
$subject = "Customer Service Executive Contact Form";
$message = $html;
